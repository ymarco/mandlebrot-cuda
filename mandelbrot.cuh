...
__device__ inline Comp rerange(unsigned int i, unsigned int j){
	Comp x;
	x.r = (double(i)  - I->RES_WIDTH/2 + I->CENTER_X  * I->RES_WIDTH)/I->RES_WIDTH ;
	x.i = (double(j) - I->RES_HEIGHT/2 + I->CENTER_Y * I->RES_HEIGHT)/I->RES_WIDTH;
